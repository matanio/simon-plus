...
<template>
 <div :class="(modeColor=='again')? 'border-red-400 bg-red-500' : 'border-blue-400 bg-blue-500'" class="opacity-100 z-50 border-4  border-gray-400 rounded-lg  m-auto  w-64 h-32 grid grid-rows-4 transition-colors  ">
